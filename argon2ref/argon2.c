...
int argon2_ctx_from_mtp(argon2_context *context, argon2_instance_t *instance) {
...
/*
int argon2d_mtp_ctx(argon2_context *context) {
	return argon2_mtp_ctx(context, Argon2_d);
}
*/
